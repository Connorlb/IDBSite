...
manager.create_api(restaurants2, methods=['GET', 'POST'], results_per_page=10, max_results_per_page=9001)
manager.create_api(ingredients2, methods=['GET'], results_per_page=9)
anager.create_api(recipes2, methods=['GET'], results_per_page=9)
